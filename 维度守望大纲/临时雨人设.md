临时雨白发红瞳，扎着最容易领便当的发型，私生活及其无聊，平常除了玩数独没有爱好，其余时候都躲在生物舱内睡觉，吊着一对死鱼眼，嘴里经常叼着香菜味的棒棒糖，吃面一定要加香菜。本身是人造人，活不过十年，所以为了活下去，人造人可以选择更换身体，而记忆可以一直传承下去，与其他清道夫不同，临时雨并不计较前生，也不好奇。
生物舱的屏幕上就是身体损耗率，当身体
人造人，无限流公司在诡维度制造的人造人，专门清理副本觉醒的NPC，人造价格222刀。
寿命只有十年，但可以选择通过更换身体活下去。
...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">  
  ...
  </head>  <body>    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">  
      <!-- Desktop sidebar -->  
        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">  
          ...
          <ul class="mt-6">  
            ...
            <button class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">  
              Create account  
              <span class="ml-2" aria-hidden="true">+</span>  
            </button>          </div>        </div>      </aside>      <div class="flex flex-col flex-1 w-full">  
